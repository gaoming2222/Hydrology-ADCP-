...
{
    public class CReportStruct:Entity.IReport
    {
        /// <summary>
        /// 站点ID
        /// </summary>
        ...
        /// 风速风向数据
        /// </summary>
        public List<CReportFsfx> fsfxDatas { get; set; }

        /// <summary>
        /// obs数据
        /// </summary>
        public List<CReportObs> obsDatas { get; set; }

        /// <summary>
        /// 能见度数据
        /// </summary>
        public List<CReportPwdData> pwdDatas { get; set; }
