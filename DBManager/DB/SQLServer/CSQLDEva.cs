...
namespace Hydrology.DBManager.DB.SQLServer
{
    public class CSQLDEva : CSQLBase, IDEvaProxy
    {
        ...
        List<CEntityEva> IDEvaProxy.GetPageData(int pageIndex, bool irefresh)
        {
            throw new NotImplementedException();
        }

        List<CEntityEva> IDEvaProxy.getEvabyTime(string stationid, DateTime start, DateTime end)
        {
            throw new NotImplementedException();
        }
    }
