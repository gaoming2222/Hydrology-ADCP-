...
namespace Hydrology.CControls
{
    ...
    /// 串口配置，至少要有一个信道协议，
    /// </summary>
    class CDataGridViewStationMap : CExDataGridView
    {
        ...
        private static readonly string CS_StationIDMap = "映射ID";
        ...
        private IStationMapProxy m_porxy;
        private List<CEntityStationMap> m_listUpdateMapStations; //  更新串口集合
        private List<int> m_listDeletedMapStations;               //  删除串口集合
        private List<CEntityStationMap> m_listAddedMapStations;    //  添加串口集合
        private List<int> m_listActualMapStationsNum;           //  机器的串口号
        ...
        public CDataGridViewStationMap()
            : base()
        {
            this.m_listUpdateMapStations = new List<CEntityStationMap>();
            this.m_listDeletedMapStations = new List<int>();
            this.m_listAddedMapStations = new List<CEntityStationMap>();
            m_listActualMapStationsNum = new List<int>();
        ...
        public void InitDataSource(IStationMapProxy proxy)
        {
            this.m_porxy = proxy;
        }
        ...
        public bool LoadData()
        {
            ...
            if (m_porxy != null)
            {
                this.SetPorts(CDBDataMgr.Instance.GetAllStationMap());
                return true;
            }
            return false;
        }
        ...
        private void SetPorts(IList<CEntityStationMap> ports)
        {
        ...
        private void GetUpdatedData()
        {
            ...
            //{
            //    var port = new CEntityMapStation();
