...
namespace Hydrology.CControls
{
    ...
    {
        //常量
        private static readonly string CS_Port = "监听端口";
        ...
        public List<string> OnlineGprsList
        {
            get { return m_onlineGprsList; }
            set { m_onlineGprsList = value; }
        }

        private List<string> m_onlineGprsList = new List<string>();
        private int m_onlineGprsCount = 0;
        private int m_onlineHDGprsCount = 0;
        ...
        public int OnlineHDGprsCount
        {
            get { return m_onlineHDGprsCount; }
            set { m_onlineHDGprsCount = value; }
        }
        public int OfflineGprsCount
        {
            get { return m_totalGprsCount - m_onlineGprsCount - m_onlineHDGprsCount; }
        }
            ...
            : base()
        {
            ...
            //调整列宽
            AutoSizeColumn(this);
            this.Columns[5].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
        ...
        public void RefreshGPRSInfo(string port, string stationName, string stationID, ModemInfoStruct dtu)
        {
            try
            {
                ...
                //string uid = "57020000000";
                string phoneno = CGprsUtil.Byte11ToPhoneNO(dtu.m_phoneno, 0);
                //string phoneno = "13212710080";
                //string dynIP = "127.0.0.1";
                //DateTime connetime = DateTime.Now;
        ...
        public void RefreshGPRSInfo_new(ushort port, string stationName, string stationID, HDModemInfoStruct dtu)
        {
            try
            {
                ...
                string phoneno = "------";
                string dynIP = this.IntToIp(dtu.m_sin_addr);
                ...
                DateTime connetime = DateTime.Parse(conntimeStr.Substring(0, 17));
                DateTime refreshTime = DateTime.Now;
                try
                {
