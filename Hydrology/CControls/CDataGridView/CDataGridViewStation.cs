...
#pragma warning restore CS0168 // 声明了变量“e”，但从未使用过
                        ...
                        Station.DataProtocol = base.Rows[m_listEditedRows[i]].Cells[CS_Dataprotocol].Value.ToString();
...
#pragma warning restore CS0168 // 声明了变量“e”，但从未使用过
                    ...
                    try
                    {
                        ...
                        if (s.Watersensor.ToString() != "")
                        {
                            n = int.Parse(s.Watersensor);
                        }
                    }
#pragma warning disable CS0168 // 声明了变量“e”，但从未使用过
                    catch (Exception e)
#pragma warning restore CS0168 // 声明了变量“e”，但从未使用过
                    ...
                    if (!xmlDll.Contains(s.DataProtocol) && s.DataProtocol != "无")
                    {
                        s.DataProtocol = "未知数据协议";
                    }
                    if (s.StationType == EStationType.ERainFall)
                    {
                        ...
                        s.Maintran.ToString(),s.Subtran.ToString(),s.DataProtocol.ToString(),"无",
