...
#pragma warning disable CS0168 // 声明了变量“ee1”，但从未使用过
                catch (Exception ee1)
#pragma warning restore CS0168 // 声明了变量“ee1”，但从未使用过
                {
...
#pragma warning disable CS0168 // 声明了变量“ee2”，但从未使用过
                catch (Exception ee2)
#pragma warning restore CS0168 // 声明了变量“ee2”，但从未使用过
                {
            ...
            this.CopyRightLabel.Text = "版权所有:湖北一方科技发展有限责任公司 V1.0    BeiDou数据接收：" + bdnum;
        }
        #endregion
