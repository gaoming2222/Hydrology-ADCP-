    ...
    public partial class CProtocolConfigForm : Form
    {
        ...
        private void btn_DataBrowse_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.OK && (!m_openFileDialog.FileName.ToString().Equals("")))
            {
                ...
                else if (this.txt_DataDllFileName.Text == "Protocol.Data.YNXY.dll")
                {
                    this.txt_DataProtocolName.Text = "YNXY";
                }
                else if (this.txt_DataDllFileName.Text == "Protocol.Data.HJJBX.dll")
                {
                    this.txt_DataProtocolName.Text = "HJJBX";
                }
                else if (this.txt_DataDllFileName.Text == "Protocol.Data.TDXY.dll")
                {
                ...
                else if (this.txt_DataDllFileName.Text == "Protocol.Data.SM100H.dll")
                {
                ...
                else if (this.txt_DataDllFileName.Text == "Protocol.data.OBS.dll")
                {
                    this.txt_DataProtocolName.Text = "OBS";
                }
