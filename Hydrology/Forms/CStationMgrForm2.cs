...
#pragma warning restore CS0168 // 声明了变量“ex”，但从未使用过
        ...
        public void InitUI()
        {
            try
            {
                ...
                if (comb_MainRoad.Text == "SX-GPRS" || comb_PrepareRoad.Text == "SX-GPRS" || comb_MainRoad.Text == "HD-GPRS" || comb_PrepareRoad.Text == "HD-GPRS")
                {
                    //通讯参数初始化
...
#pragma warning restore CS0168 // 声明了变量“ex”，但从未使用过
        ...
        private void comb_MainRoad_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                textBox_BeidouMember.Text = "";
                textBox_BeidouMember.Enabled = false;
                if (comb_PrepareRoad.Text == "SX-GPRS" || comb_PrepareRoad.Text == "HD-GPRS")
                {
                    textBox_GPRS.Enabled = true;
                    textBox_GPRS.Text = "00000001";
                }
                else if (comb_PrepareRoad.Text == "GSM")
                {
                    textBox_GSM.Enabled = true;
                    textBox_GSM.Text = "13211111111";
                }
                ...
                if (comb_MainRoad.Text == "SX-GPRS" || comb_MainRoad.Text == "HD-GPRS")
                {
                    textBox_GPRS.Enabled = true;
                    textBox_GPRS.Text = "00000001";
                }
                else if (comb_MainRoad.Text == "GSM")
                {
                    textBox_GSM.Enabled = true;
                    textBox_GSM.Text = "13211111111";
                }
